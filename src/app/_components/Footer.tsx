...
function Footer() {
    ...
    return (
      <footer
        className="flex flex-col gap-3 px-3 md:px-10 py-5 sm:grid sm:grid-cols-3 h-max w-full  font-poppins text-white
      ...
      >
        <div className="sm:flex justify-center md:h-[84px] hidden">
          <p className={styleContact}>
            <IoLocationOutline /> Recife, Pernambuco
          </p>
        </div>
